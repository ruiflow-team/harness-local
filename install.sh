...
VERSION="v0.24.5-beta"
FILE="harness-local-v0.24.5-beta.zip"
...
echo "Checksum OK"
rm -rf harness-local-v0.24.5-beta
unzip -q "$FILE"

echo "Installed to: $INSTALL_DIR/harness-local-v0.24.5-beta"
echo "Run:"
echo "  cd '$INSTALL_DIR/harness-local-v0.24.5-beta'"
echo "  ./harness serve"
