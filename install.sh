...
FILE="harness-local-v0.26.1-beta.zip"
...
echo "Checksum OK"
rm -rf harness-local-v0.26.1-beta
unzip -q "$FILE"

echo "Installed to: $INSTALL_DIR/harness-local-v0.26.1-beta"
echo "Run:"
echo "  cd '$INSTALL_DIR/harness-local-v0.26.1-beta'"
echo "  ./harness serve"
