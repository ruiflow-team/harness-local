...
```text
harness-local-v0.24.6-beta.zip
```
...
- `./harness feedback-bundle`：生成本地脱敏反馈包，目录为 `dist/evidence/TRIAL-BUNDLE/`；提交公开 issue 前请人工检查 `README.md`、`FEEDBACK-SUMMARY.md`、`doctor.json`，确认没有密钥、私有源码或客户数据。
