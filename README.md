[![Release](https://img.shields.io/badge/release-v0.25.4--beta-2ECFB0)](https://github.com/ruiflow-team/harness-local/releases/tag/v0.25.4-beta)
...
```bash
curl -L -o harness-local-v0.25.4-beta.zip \
  https://github.com/ruiflow-team/harness-local/releases/download/v0.25.4-beta/harness-local-v0.25.4-beta.zip

shasum -a 256 harness-local-v0.25.4-beta.zip
...
- Release：<https://github.com/ruiflow-team/harness-local/releases/tag/v0.25.4-beta>
- Package：`harness-local-v0.25.4-beta.zip`
...
候选包：`harness-local-v0.25.4-beta.zip`
SHA256：`671e3ef69f40820885d681921f0f26d59cc0d4109e75f745d1eafa8d50cbab1f`


## v0.25.4 Beta：体检报告边界增强

v0.25.4 Beta 在 `doctor-report` 中新增：
...
## v0.25.4 Beta：机器可读声明边界

v0.25.4 Beta 在 `./harness doctor` JSON 中新增机器可读结构：
...
## v0.25.4 Beta：checkup-sample schema 文档化

v0.25.4 Beta 补齐了 `./harness checkup-sample` 的字段说明和安全解读规则：

- 新增 `docs/CHECKUP-SAMPLE-SCHEMA.md`
- `checkup-sample.json` schema 更新为 `harness-checkup-sample-v0.25.4`
- `share_contract.version` 更新为 `share-contract-v0.25.4`
