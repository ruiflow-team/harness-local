[![Release](https://img.shields.io/badge/release-v0.25.3--beta-2ECFB0)](https://github.com/ruiflow-team/harness-local/releases/tag/v0.25.3-beta)
...
```bash
curl -L -o harness-local-v0.25.3-beta.zip \
  https://github.com/ruiflow-team/harness-local/releases/download/v0.25.3-beta/harness-local-v0.25.3-beta.zip

shasum -a 256 harness-local-v0.25.3-beta.zip
unzip harness-local-v0.25.3-beta.zip
cd harness-local-v0.25.3-beta
./harness serve
```
...
- Release：<https://github.com/ruiflow-team/harness-local/releases/tag/v0.25.3-beta>
- Package：`harness-local-v0.25.3-beta.zip`
- SHA256：`8caefac9ac3f8b5fdd133890a55086f78f82a5f04cfd4c5ebc46eed67d519402`
...
候选包：`harness-local-v0.25.3-beta.zip`
SHA256：`8caefac9ac3f8b5fdd133890a55086f78f82a5f04cfd4c5ebc46eed67d519402`


## v0.25.3 Beta：体检报告边界增强

v0.25.3 Beta 在 `doctor-report` 中新增：
...
## v0.25.3 Beta：机器可读声明边界

v0.25.3 Beta 在 `./harness doctor` JSON 中新增机器可读结构：
