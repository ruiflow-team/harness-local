[![Release](https://img.shields.io/badge/release-v0.26.0--beta-2ECFB0)](https://github.com/ruiflow-team/harness-local/releases/tag/v0.26.0-beta)
...
Harness Local v0.26.0 新增 `./harness project-checkup`：在本地生成 AI 项目体检包，包含 Markdown 报告、JSON 合同、安全分享清单和 share contract。
...
```bash
curl -L -o harness-local-v0.26.0-beta.zip \
  https://github.com/ruiflow-team/harness-local/releases/download/v0.26.0-beta/harness-local-v0.26.0-beta.zip

shasum -a 256 harness-local-v0.26.0-beta.zip
unzip harness-local-v0.26.0-beta.zip
cd harness-local-v0.26.0-beta
./harness serve
```
...
- Release：<https://github.com/ruiflow-team/harness-local/releases/tag/v0.26.0-beta>
- Package：`harness-local-v0.26.0-beta.zip`
- SHA256：`a67a5a280bfae6a87eada3d0cfac804f91b04745a9a2b23a782415233f6072b0`
...
候选包：`harness-local-v0.26.0-beta.zip`
SHA256：`a67a5a280bfae6a87eada3d0cfac804f91b04745a9a2b23a782415233f6072b0`


## v0.26.0 Beta：体检报告边界增强

v0.26.0 Beta 在 `doctor-report` 中新增：
...
## v0.26.0 Beta：机器可读声明边界

v0.26.0 Beta 在 `./harness doctor` JSON 中新增机器可读结构：
...
## v0.26.0 Beta：checkup-sample schema 文档化

v0.26.0 Beta 补齐了 `./harness checkup-sample` 的字段说明和安全解读规则：

- 新增 `docs/CHECKUP-SAMPLE-SCHEMA.md`
- `checkup-sample.json` schema 更新为 `harness-checkup-sample-v0.26.0`
- `share_contract.version` 更新为 `share-contract-v0.26.0`
