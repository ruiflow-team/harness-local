[![Release](https://img.shields.io/badge/release-v0.24.3--beta-2ECFB0)](https://github.com/ruiflow-team/harness-local/releases/tag/v0.24.3-beta)
...
```bash
curl -L -o harness-local-v0.24.3-beta.zip \
  https://github.com/ruiflow-team/harness-local/releases/download/v0.24.3-beta/harness-local-v0.24.3-beta.zip
...
- Release：<https://github.com/ruiflow-team/harness-local/releases/tag/v0.24.3-beta>
- Package：`harness-local-v0.24.3-beta.zip`
- SHA256：`7e4da385e3ce652d70ad3e85f4eb9e121727a49fde87e69521313ee6ce6d623b`
