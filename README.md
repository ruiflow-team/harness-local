[![Release](https://img.shields.io/badge/release-v0.25.1--beta-2ECFB0)](https://github.com/ruiflow-team/harness-local/releases/tag/v0.25.1-beta)
...
```bash
curl -L -o harness-local-v0.25.1-beta.zip \
  https://github.com/ruiflow-team/harness-local/releases/download/v0.25.1-beta/harness-local-v0.25.1-beta.zip

shasum -a 256 harness-local-v0.25.1-beta.zip
unzip harness-local-v0.25.1-beta.zip
cd harness-local-v0.25.1-beta
./harness serve
```
...
- Release：<https://github.com/ruiflow-team/harness-local/releases/tag/v0.25.1-beta>
- Package：`harness-local-v0.25.1-beta.zip`
...
候选包：`harness-local-v0.25.1-beta.zip`
SHA256：`010f58e5cf97b0024d8276c02d8939f032a44be19e41afe0d675d2e5afdc821e`


## v0.25.1 Beta：体检报告边界增强

v0.25.1 Beta 在 `doctor-report` 中新增：
