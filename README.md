[![Release](https://img.shields.io/badge/release-v0.24.6--beta-2ECFB0)](https://github.com/ruiflow-team/harness-local/releases/tag/v0.24.6-beta)
...
- 新增 `./harness feedback-bundle`：生成本地脱敏反馈包，便于提交安装/自检问题，不包含源码、密钥或原始反馈 JSONL；v0.24.6 修复安装包解压后独立运行该命令不依赖原始 zip。
...
```bash
curl -L -o harness-local-v0.24.6-beta.zip \
  https://github.com/ruiflow-team/harness-local/releases/download/v0.24.6-beta/harness-local-v0.24.6-beta.zip

shasum -a 256 harness-local-v0.24.6-beta.zip
unzip harness-local-v0.24.6-beta.zip
cd harness-local-v0.24.6-beta
./harness serve
```
...
- Release：<https://github.com/ruiflow-team/harness-local/releases/tag/v0.24.6-beta>
- Package：`harness-local-v0.24.6-beta.zip`
- SHA256：`3b3bf17cd9bf2356f6d4f9ac44f5b04a1fa0e09875baf7831635f26bfabc0db3`
